  ...
  return (
    <div className="min-h-screen bg-bg text-text flex items-center justify-center px-4 py-10">
      ...
      >
        ...
        <div className="p-4 rounded-xl bg-bg border flex items-center gap-2  border-muted text-sm text-muted">
          <FaLightbulb /> Tip: Add clear explanation and optimized approach.
        </div>
